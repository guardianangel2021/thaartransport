...
class AcceptedReceivedBids extends StatefulWidget {
  PostModal posts;
  AcceptedReceivedBids({required this.posts});

  @override
  _AcceptedReceivedBidsState createState() => _AcceptedReceivedBidsState();
}

class _AcceptedReceivedBidsState extends State<AcceptedReceivedBids> {
  @override
  bool validate = false;
  bool loading = false;
    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasError) {
            ...
            return const Center(
                child: Text("Yet Not Accepted Bids",
