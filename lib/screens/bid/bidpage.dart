...
class _BidPageState extends State<BidPage> {
  ...
  Widget build(BuildContext context) {
    bool isMe = UserService().currentUid() == widget.posts.ownerId;
    return Scaffold(
      body: SafeArea(
        ...
        children: [
          ...
          widget.posts.bidresponse == "" ? response() : Text("data")
        ],
      ))),
    );
  }
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, int index) {
                ...
                return AnotheruserBid(post.rate!, post.remarks!);
              });
        });
  }

  Widget AnotheruserBid(String rate, String remakrs) {
    return Padding(
      ...
      child: Card(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: widget.posts.bidresponse == ""
