...
class RejectedBids extends StatefulWidget {
  const RejectedBids({Key? key}) : super(key: key);

  @override
  _RejectedBidsState createState() => _RejectedBidsState();
}

class _RejectedBidsState extends State<RejectedBids> {
  @override
    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasError) {
            ...
            return const Center(
                child:
                    Text("Not rejected loads", style: TextStyle(fontSize: 18)));
          }
